...
class LegacyXliffFileLoader implements LoaderInterface
{
    public function load($resource, $locale, $domain = 'messages')
    {
        ...
        foreach ($xml->xpath('file/body/trans-unit') as $translation) {
            ...
            $source = isset($attributes['id']) && $attributes['id'] ? $attributes['id'] : $translation->source;
            $target = (string) $translation->target ?: (string) $translation->source;
